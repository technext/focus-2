                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-outline-primary" href="NilaiUASDetail.php?mapel=<?php echo $row['kode_mapel']; ?>&kelas=<?php echo $row['kode_kelas']; ?>&jurusan=<?php echo $row['kode_jurusan']; ?>&nip=<?php echo $row['nip']; ?>" data-toggle="tooltip"data-placement="top" title="Edit">Detail</a>
                                    </td>
                                </tr>
                                <?php } ?>       
                            </tbody>
