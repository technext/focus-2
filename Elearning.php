        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="Elearning.php">Bahan</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <h1 class="card-title">Bahan Mata pelajaran</h1>
                </div>
                    ...
                    <div class="table-responsive">
                        <table id="example" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                <?php 
                                    $no = 1;
                                    $sql_elearning = "SELECT DISTINCT kode_jurusan, kode_kelas, kode_mapel, nip FROM tb_elearning WHERE npsn='".$row_admin['npsn']."'";
                                    $query_elearning = $conn->query($sql_elearning);
                                    while ($row = $query_elearning->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span><a href="ElearningDetail.php?<?php echo "jurusan=".$row['kode_jurusan']."&kelas=".$row['kode_kelas']."&mapel=".$row['kode_mapel']."&nip=".$row['nip']; ?>" class="btn btn-outline-primary">Detail</a></span>
                                    </td>
                                </tr>
                                <?php  } ?>
                            </tbody>
