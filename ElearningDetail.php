        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="ELearningDetail.php">E-Learning Detail</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <?php 
                                        $sql_elerning = "SELECT * FROM tb_elearning WHERE npsn='".$row_admin['npsn']."' AND kode_jurusan='".$kode_jurusan."' AND kode_kelas='".$kode_kelas."' AND kode_mapel='".$kode_mapel."' AND nip='".$nip."' ORDER BY pertemuan DESC" ;
                                    ...
                                    <tr>
                                        ...
                                        <td><a target="_blank" class="btn btn-outline-primary" href="../assets/files/<?php echo $row['bahan']; ?>" >Download</a></td>
                                        <?php
                                            if(!empty($row['video']))
