...
<head>
    ...
    <title>SiPren </title>
    <!-- Favicon icon -->
    <link rel="icon" type="./images/png" sizes="30x30" href="./images/sipren.png">
        ...
        ***********************************-->
        <div class="nav-header" align="center">
            <a href="index.php" class="brand-logo" >
                <img src="./images/siprenputih.png" alt="" style="width:100px; margin-left: 23%;">
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <marquee direction="right" style="width:100px; height:40px; color: #39B44A;
